...
document.querySelector('.sb-icon').addEventListener('click', function (e) {
    var _inputIngredientes = document.querySelector('.search-bar input');

    acharReceitas(_inputIngredientes.value);
});